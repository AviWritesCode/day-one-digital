...
var Swiper = (function () {
  ...
  var O = {
    ...
    updateSlides: function () {
        ...
        if (
          ...
          if ("auto" === s.slidesPerView) {
            ...
            if (
              ...
              I = e.isHorizontal() ? w(r, "width", !0) : w(r, "height", !0);
            else {
              const e = t(n, "width"),
                s = t(n, "padding-left"),
                i = t(n, "padding-right"),
            ...
            (I = (n - (s.slidesPerView - 1) * y) / s.slidesPerView),
              s.roundLengths && (I = Math.floor(I)),
              c[i] && (c[i].style[e.getDirectionLabel("width")] = `${I}px`);
          c[i] && (c[i].swiperSlideSize = I),
            g.push(I),
            s.centeredSlides
              ? ((E = E + I / 2 + M / 2 + y),
                0 === M && 0 !== i && (E = E - n / 2 - y),
      ...
      if (
        ...
        C && e.grid.updateWrapperSize(I, f),
        !s.centeredSlides)
      ) {
        const t = [];
    ...
    updateSlidesProgress: function (e) {
      ...
      for (let e = 0; e < i.length; e += 1) {
        ...
        m && (t.visibleSlides.push(l), t.visibleSlidesIndexes.push(e)),
          P(l, m, s.slideVisibleClass),
          P(l, f, s.slideFullyVisibleClass),
          (l.progress = r ? -c : c),
    ...
    updateSlidesClasses: function () {
      ...
      l &&
        ...
        t.forEach((e) => {
          C(e, e === l, s.slideActiveClass),
            C(e, e === c, s.slideNextClass),
            C(e, e === d, s.slidePrevClass);
        }),
        e.emitSlidesClasses();
    },
  ...
  var G = {
    slideTo: function (e, t, s, i, r) {
      ...
      if (!(T && r) && ((h && -w === n.translate) || (!h && w === n.translate)))
        return (
      ...
      const b = E().isSafari;
      return (
        T && !r && b && n.isElement && n.virtual.update(!1, !1, a),
        n.setTransition(t),
        n.setTranslate(w),
        n.updateActiveIndex(a),
        n.updateSlidesClasses(),
      ...
      if (t.loop) {
        ...
        (r = parseInt(
          ...
          t.centeredSlides
            ...
            ? (e.loopFix(),
              (n = e.getSlideIndex(
                h(s, `${o}[data-swiper-slide-index="${r}"]`)[0]
              )),
              a(() => {
                e.slideTo(n);
              }))
  ...
  var _ = {
    loopCreate: function (e, t) {
      ...
      const n = () => {
          h(r, `.${i.slideClass}, swiper-slide`).forEach((e, t) => {
            e.setAttribute("data-swiper-slide-index", t);
          });
        },
        a = s.grid && i.grid && i.grid.rows > 1;
      i.loopAddBlankSlides &&
        (i.slidesPerGroup > 1 || a) &&
        (() => {
          const e = h(r, `.${i.slideBlankClass}`);
          e.forEach((e) => {
            e.remove();
          }),
    ...
    loopFix: function (e) {
      ...
      let T = v ? Math.max(S, Math.ceil(w / 2)) : S;
      T % S != 0 && (T += S - (T % S)),
        (T += m.loopAdditionalSlides),
        (d.loopedSlides = T);
      const b = d.grid && m.grid && m.grid.rows > 1;
      c.length < w + T || ("cards" === d.params.effect && c.length < w + 2 * T)
        ? f(
      ...
      let L = 0,
        k = 0;
      const O = (b ? c[n].column : n) + (v && void 0 === r ? -w / 2 + 0.5 : 0);
      if (O < T) {
        L = Math.max(T - O, S);
        ...
        (k = Math.max(O - (E - 2 * T), S)),
          M && (k = Math.max(k, w - E + g + 1));
        for (let e = 0; e < k; e += 1) {
          const t = e - Math.floor(e / E) * E;
          b
            ? c.forEach((e, s) => {
      ...
      if (
        ...
        "cards" === d.params.effect &&
          c.length < w + 2 * T &&
          (y.includes(n) && y.splice(y.indexOf(n), 1),
        ...
        if (x.length > 0 && I) {
          if (void 0 === t) {
            const e = d.slidesGrid[P],
              t = d.slidesGrid[P + L] - e;
            l
              ? d.setTranslate(d.translate - t)
              : (d.slideTo(P + Math.ceil(L), 0, !1, !0),
                r &&
      ...
      if (
        ((d.allowSlidePrev = p),
        (d.allowSlideNext = u),
        d.controller && d.controller.control && !o)
      ) {
        const e = {
          slideRealIndex: t,
          direction: i,
  ...
  function V(e) {
    ...
    p.matches(a.focusableElements) &&
      ((w = !1), "SELECT" === p.nodeName && (a.isTouched = !1)),
      s.activeElement &&
  ...
  function B(e) {
    ...
    if (!s.allowTouchMove)
      return (
        ...
        void (
          r.isTouched &&
          (Object.assign(a, { startX: u, startY: h, currentX: u, currentY: h }),
          (r.touchStartTime = o()))
        )
      );
  ...
  function N(e) {
    ...
    for (
      ...
      void 0 !== c[e + t]
        ? (m || (f >= c[e] && f < c[e + t])) && ((v = e), (g = c[e + t] - c[e]))
        : (m || f >= c[e]) &&
    ...
    if (h > n.longSwipesMs) {
      ...
      "next" === t.swipeDirection &&
        (T >= n.longSwipesRatio
          ? t.slideTo(n.rewind && t.isEnd ? w : v + b)
          : t.slideTo(v)),
        "prev" === t.swipeDirection &&
          (T > 1 - n.longSwipesRatio
            ? t.slideTo(v + b)
            : null !== S && T < 0 && Math.abs(T) > n.longSwipesRatio
            ? t.slideTo(S)
            : t.slideTo(v));
    } else {
      ...
      (r.target === t.navigation.nextEl || r.target === t.navigation.prevEl)
        ? r.target === t.navigation.nextEl
          ? t.slideTo(v + b)
          : t.slideTo(v)
        : ("next" === t.swipeDirection && t.slideTo(null !== w ? w : v + b),
          "prev" === t.swipeDirection && t.slideTo(null !== S ? S : v));
    }
  }
  function F() {
    const e = this,
  ...
  const U = {
      ...
      breakpoints: {
        setBreakpoint: function () {
          ...
          const u = (p in a ? a[p] : void 0) || e.originalParams,
            h = X(e, r),
            f = X(e, u),
  ...
  class J {
    constructor() {
      ...
      (o.__swiper__ = !0),
        (o.support = x()),
        (o.device = y({ userAgent: t.userAgent })),
        (o.browser = E()),
        (o.eventsListeners = {}),
